...
<aside class="lg:col-span-1 bg-white rounded-xl border border-slate-200 shadow-sm self-start overflow-hidden">
  ...
  <div class="js-filter-content hidden lg:block p-3 lg:p-4 lg:pt-0">
    ...
    <div class="mb-6 border-t border-slate-100 pt-5">
      ...
      <div class="relative">
        <select class="js-condition-select w-full appearance-none bg-white border border-slate-200 text-slate-700 text-sm rounded-xl p-3 pr-10 outline-none focus:border-astra-500 focus:ring-1 focus:ring-astra-500 cursor-pointer transition-all shadow-sm hover:shadow-md">
    ...
    <div class="border-t border-slate-100 pt-5">
      ...
      <div class="relative">
        <select class="js-sort-select w-full appearance-none bg-white border border-slate-200 text-slate-700 text-sm rounded-xl p-3 pr-10 outline-none focus:border-astra-500 focus:ring-1 focus:ring-astra-500 cursor-pointer transition-all shadow-sm hover:shadow-md">
